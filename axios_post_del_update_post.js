$(document).ready(function () {
  ...
  // var userdata = "http://localhost:5500/users";

  axios.get(userdata + "/posts?userId=1").then(function (post) {
    ...
    $(".edit-user-class").click(function () {
      axios
        .get(userdata + "/posts/" + $(this).attr("user-id"))
        .then((edituser) => {
    ...
    $("#editForm").submit(function (event) {
      if (!$(this)[0].checkValidity()) {
        ...
        axios.patch(userdata + "/posts/" + data.id, data).then((res) => {
          let user = res.data;
          console.log(user);
    ...
    $('#RegForm').submit(function (event) {
      if (!$(this)[0].checkValidity()) {
        ...
        axios.post(userdata + "/posts", data).then((res) => {
          let user = res.data;
          console.log(user);
